    ...
    init : function(component, event, helper) {
        ...
        */
        ...
        component.set('v.columns', [
            {label: 'Number', fieldName: 'accountNumber', type: 'text',sortable:true},
            {label: 'Branch', fieldName: 'branch', type: 'text',sortable:true },
            {label: 'Currency', fieldName: 'currency', type: 'text',sortable:true},
            {label: 'Available Balance ', fieldName: 'availableBalance', type: 'text',sortable:true},
