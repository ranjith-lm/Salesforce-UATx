        ...
        function(response) {
			...
			for(var h = 0; h < uniqCurrency.length; h++){
				...
				for(var i = 0; i < data.termDepositMatrixs.length; i++){
				   ...
				   if(data.termDepositMatrixs[i].segmentId === 'Staff' && data.termDepositMatrixs[i].currency.code === 'BHD' && uniqCurrency[h] === 'BHD'){
					...
					else if(data.termDepositMatrixs[i].segmentId === 'Staff' && data.termDepositMatrixs[i].currency.code === 'USD' && uniqCurrency[h] === 'USD'){
						var fromAmount = data.termDepositMatrixs[i].fromAmount;
						var toAmount = data.termDepositMatrixs[i].toAmount;
						var amtRange;
						if(fromAmount != toAmount){
