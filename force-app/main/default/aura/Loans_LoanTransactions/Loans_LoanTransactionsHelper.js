({
    ...
    getDefaultSearchJson: function(component, customerId, loanId,jsonToDate,jsonFromDate) {
     ...
     getSearchJson: function(component, customerId, loanId) {
        var searchParametersJson = {
            "id": loanId,
            "offSet": 0,
     ...
     */
    loadTransactions: function(component, customerId, loanId, providedSearchParametersJson, previouslyLoadedTransactions, prevTransactionLength) {
        console.log('loadTransactions(customerId=' + customerId + ', loanId=' + loanId + ')');
        var helper = this;
        var today = new Date(
        ...
        var defaultSearchParametersJson = helper.getDefaultSearchJson(component, customerId, loanId,jsonToDate,jsonFromDate);
        ...
        console.log('offset value',searchParametersJson.offSet);
            ...
            component.find('apexService').request(component.get('c.loadLoanTransactions'), {
                "customerId": customerId,
                "searchParametersJson": JSON.stringify(searchParametersJson),
                "regionName" : regionName
            },
            function(response) {
                component.set('v.viewTransactions', true);
                ...
                if (helper.BATCH_SIZE == recordLength && prevTransactionLength<0) {
                    ...
                    helper.loadTransactions(component, customerId, loanId, searchParametersJson, data, totalRecordLength);
                } else {
    ...
    loadTransactionSearch: function(component, customerId, loanId, providedSearchParametersJson, previouslyLoadedTransactions, prevTransactionLength) {
        console.log('loadTransactions(customerId=' + customerId + ', loanId=' + loanId + ')');
        var helper = this;
        var defaultSearchParametersJson = helper.getSearchJson(component, customerId, loanId);
		var defaultSearchParametersAsBlank = helper.getDefaultSearchJson(component, customerId, loanId);
        var searchParametersJson = undefined === providedSearchParametersJson ? defaultSearchParametersJson : providedSearchParametersJson;
		console.log('prevTransactionLength', prevTransactionLength);
        prevTransactionLength = prevTransactionLength && prevTransactionLength > 0 ? prevTransactionLength : 0;
        ...
        function(response) {
            	...
            	if (helper.BATCH_SIZE_SEARCH == recordLength) {
                    ...
                    if(totalRecordLength <= helper.API_CALL_RECORD_SIZE_LMT){
                        helper.loadTransactionSearch(component, customerId, loanId, searchParametersJson, data,totalRecordLength);
                    }
                    else{
                        component.set('v.gridDataRows', data);
    ...
    runSearch: function(component, customerId, loanId) {
        var helper = this;
        ...
        var helper = this;
        var searchParametersJson = helper.getSearchJson(component, customerId, loanId);
        ...
        helper.loadTransactionSearch(component, customerId, loanId, searchParametersJson);
    },  
