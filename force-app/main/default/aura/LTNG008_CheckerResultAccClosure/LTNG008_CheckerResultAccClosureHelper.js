({
    updateCheckerSection : function (component, event, helper) {
        helper.showSpinner(component);
        var fields = event.getParam("fields");

        var action = component.get('c.updateCheckerSection');
        action.setParams({
            caseId : component.get("v.recordId"),
            checkerResults : fields["cc_Checker_Result__c"],
            checkerComments : fields["cc_Checker_Comments__c"]
		});
