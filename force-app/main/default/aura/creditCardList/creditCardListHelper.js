  ...
  //CH09: Start
    ...
    loadBTColumns: function(component) {
        var btColumns = [
            ...
            { label: 'Sequence Number', fieldName: 'sequenceNumber', type: 'text', sortable: true },
            { label: 'Plan Balance', fieldName: 'planBalance', type: 'currency', 
              typeAttributes: { currencyCode: 'BHD', maximumFractionDigits: 2 }, sortable: true }
        ];
    ...
    loadBTPlans: function(component, selectedCard) {
        ...
        component.find('apexService').request(component.get('c.getActiveBTPlans'), {
            ...
            if (response.getState() === "SUCCESS") {
                ...
                if (result.isSuccess) {
                    component.set("v.btPlans", result.responseData || []);
                }
            }
        });
