...
import getCaseAnnexFieldsMap from '@salesforce/apex/LoanServiceRequest_FinDetailsController.getCaseAnnexFieldsMap';
import getCaseFieldsMap from '@salesforce/apex/LoanServiceRequest_FinDetailsController.getCaseFieldsMap';
import fetchBcrbDetails from '@salesforce/apex/LoanServiceRequest_FinDetailsController.fetchBcrbDetails';
import reviewBcrbDetails from '@salesforce/apex/LoanServiceRequest_FinDetailsController.reviewBcrbDetails';
import generateRepaymentSchedule from '@salesforce/apex/LoanServiceRequest_FinDetailsController.generateRepaymentSchedule';
import getSimulationPaymentList from '@salesforce/apex/LoanServiceRequest_FinDetailsController.getSimulationPaymentList';
...
export default class LoanServiceRequest_FinancialDetails extends LightningElement {
  @wire(MessageContext)
  messageContext;
  ...
  @track subType;
  @track cx_Approved_Partial_payment_option;
  @track cx_ln_RestructureOption;
  ...
  wiredGetCaseFields(result) {
    ...
    if (result.data) {
      ...
      this.subType = caseRecord.sub_type__c;
  ...
  wiredGetCaseAnnexFields(result) {
    ...
    console.log('case annex result### ' + JSON.stringify(result.data));
    if (result.data) {
      ...
      if (result.data[0].cx_ln_isschedulegenerated__c == false) {
      ...
      this.cx_Approved_Partial_payment_option = result.data[0].cx_approved_partial_payment_option__c;
      console.log('cx_Approved_Partial_payment_option#### ' + this.cx_Approved_Partial_payment_option);
      this.cx_ln_RestructureOption = result.data[0].cx_ln_restructureoption__c;
      console.log('cx_ln_RestructureOption#### ' + this.cx_ln_RestructureOption);
  ...
  async fetchConfigJson() {
    try {
      ...
      let jsonData = [];
      //commun section : "Current Loan Details"
      jsonData.push(
        {
          "sectionName": "Current Loan Details",
          "fields": [
            {
              "objectName": "CaseAnnex__c",
              "fieldAPIName": "cx_ln_Current_Remaining_principal_amount__c",
              "readOnly": true,
              "required": false,
            ...
            {
              "objectName": "CaseAnnex__c",
              "fieldAPIName": "cx_ln_Current_Accrued_interest_amount__c",
              "readOnly": true,
              "required": false,
              "visibilityFilter": true
            },
            {
              "objectName": "CaseAnnex__c",
              "fieldAPIName": "PartialRepaymentFee__c",
              "labelName": "Current Partial settlement fee",
              "readOnly": true,
              "required": false,
              "visibilityFilter": (this.subType == 'Partial Settlement') ? true : false
            },
            {
              "objectName": "CaseAnnex__c",
              "fieldAPIName": "cx_ln_Early_Settlement_fee_VAT__c",
              "labelName": "Current Partial settlement fee VAT",
              "readOnly": true,
              "required": false,
              "visibilityFilter": (this.subType == 'Partial Settlement') ? true : false
            },
            {
              "objectName": "CaseAnnex__c",
              "fieldAPIName": "cc_ln_Early_Settlement_fee_VAT_inclusive__c",
              "labelName": "Current Full Partial settlement fee (VAT inclusive)",
              "readOnly": true,
              "required": false,
              "visibilityFilter": (this.subType == 'Partial Settlement') ? true : false
            },
            {
              "objectName": "CaseAnnex__c",
              "fieldAPIName": "cx_Current_Remaining_administration_fee__c",
              "readOnly": true,
              "required": false,
              "visibilityFilter": true
            },
            {
              "objectName": "CaseAnnex__c",
              "fieldAPIName": "cx_Current_RemainingAdministrationFeeVAT__c",
              "readOnly": true,
              "required": false,
              "visibilityFilter": true
            },
            {
              "objectName": "CaseAnnex__c",
              "fieldAPIName": "cx_Full_Remaining_administration_fee__c",
              "labelName": "Current Full Remaining administration fee (VAT inclusive)",
              "readOnly": true,
              "required": false,
              "visibilityFilter": true
            },
            {
              "objectName": "CaseAnnex__c",
              "fieldAPIName": "cx_Current_Late_payment_charges__c",
              "labelName": "Current Late payment charges (if any)",
              "readOnly": true,
              "required": false,
              "visibilityFilter": true
            },
            {
              "objectName": "CaseAnnex__c",
              "fieldAPIName": "cx_Current_Late_payment_charges_VAT__c",
              "labelName": "Current Late payment charges (if any) VAT",
              "readOnly": true,
              "required": false,
              "visibilityFilter": true
            },
            {
              "objectName": "CaseAnnex__c",
              "fieldAPIName": "cx_Full_late_payment_charges_VAT_inlu__c",
              "labelName": "Current Full late payment charges (VAT inclusive)",
              "readOnly": true,
              "required": false,
              "visibilityFilter": true
            },
            {
              "objectName": "CaseAnnex__c",
              "fieldAPIName": "cx_Insurance_amount_assessment__c",
              "labelName": "Current Insurance amount assessment and retrieval",
              "readOnly": true,
              "required": false,
              "visibilityFilter": true
            },
            {
              ...
              "labelName": "Current Maturity Date",
              "readOnly": true,
              "required": false,
              "visibilityFilter": true
            },
            {
              "objectName": "CaseAnnex__c",
              "fieldAPIName": "cx_Total_Payoff_amount__c",
              "readOnly": true,
              "required": false,
              "visibilityFilter": true
            },
            {
              ...
              "labelName": "Original Installment Amount",
              "readOnly": true,
              "required": false,
              "visibilityFilter": true
            }
          ...
          "fields": [
            {
              ...
              "labelName": (this.subType == 'Top-up') ? "Approved top up amount" : "Approved Partial payment amount",
              "readOnly": false,
              "required": true,
              "visibilityFilter": (this.subType == 'Partial Settlement' || this.subType == 'Top-up') ? true : false
            },
            {
              "objectName": "CaseAnnex__c",
              "fieldAPIName": "cx_Approved_Partial_payment_option__c",
              "labelName": (this.subType == 'Top-up') ? "Approved top up option" : "Approved Partial payment option",
              "readOnly": false,
              "required": true,
              "visibilityFilter": (this.subType == 'Partial Settlement' || this.subType == 'Top-up') ? true : false
            },
            {
              "objectName": "CaseAnnex__c",
              "fieldAPIName": "cx_ln_RestructureOption__c",
              "labelName": "Approved Restructure option",
              "readOnly": false,
              "required": true,
              "visibilityFilter": (this.subType == 'Restructuring') ? true : false
            },
            {
              "objectName": "CaseAnnex__c",
              "fieldAPIName": "cx_ln_Approved_Duration_Months__c",
              "labelName": "Approved New term",
              "readOnly": false,
              "required": true,
              "visibilityFilter": (this.subType == 'Restructuring' && (this.cx_ln_RestructureOption == 'Change loan term' || this.cx_ln_RestructureOption == 'Change term and rate' || this.cx_ln_RestructureOption == 'Change term without interest increase')) ? true : false
            },
            {
              "objectName": "CaseAnnex__c",
              "fieldAPIName": "cx_ln_Approved_Duration_Months__c",
              "labelName": "Approved Loan Duration",
              "readOnly": true,
              "required": false,
              "visibilityFilter": (this.subType != 'Restructuring' && this.subType != 'Top-up' && this.subType != 'Partial Settlement') ? true : false
            },
            {
              "objectName": "CaseAnnex__c",
              "fieldAPIName": "cx_ln_ApprovedNewRate__c",
              "labelName": "Approved New rate",
              "readOnly": false,
              "required": true,
              "visibilityFilter": (this.subType == 'Restructuring' && (this.cx_ln_RestructureOption == 'Change interest rate' || this.cx_ln_RestructureOption == 'Change term and rate')) ? true : false
            },
            {
              "objectName": "CaseAnnex__c",
              "fieldAPIName": "EarlyRepaymentPrincipalAmount__c",
              "labelName": "New Loan Principal",
              "readOnly": true,
              "required": false,
              "visibilityFilter": true
            },
            {
              "objectName": "CaseAnnex__c",
              "fieldAPIName": "ApprovedLoanTopUpDuration__c",
            ...
            },
            {
              ...
              "readOnly": (this.subType == 'Restructuring' ) ? true : false, //changed as per UATNB-214595
              "required": false,
              "visibilityFilter": true
            },
            {
            ...
            },
            {
              ...
              "labelName": "First Installment Date",
              "readOnly": true,
              "required": false,
              "visibilityFilter": true
            },
            {
              ...
              "labelName": "Processing Fee (VAT Inclusive)",
              "readOnly": true,
              "required": false,
              "visibilityFilter": true
            },
            {
              "objectName": "CaseAnnex__c",
              "fieldAPIName": "cx_ln_SR_Final_DBR__c",
              "readOnly": true,
              "required": false,
              "visibilityFilter": true
            },
  ...
  processJsonConfig(jsonObject, caseRecord, caseAnnex) {
    ...
    jsonObject.forEach(section => {
      ...
      if (section.sectionName === 'Current Loan Details' && (this.subType === 'Partial Settlement' || this.subType === 'Restructuring')) {
  ...
  handleInputFocusOut(event) {
    try {
      ...
      if (fieldName == 'cx_Approved_Partial_payment_option__c') {
        this.cx_Approved_Partial_payment_option = this.template.querySelector(`[data-field-name="cx_Approved_Partial_payment_option__c"][data-object-name="CaseAnnex__c"]`)?.value;
        this.fetchConfigJson();
      }
      if (fieldName == 'cx_ln_RestructureOption__c') {
        this.cx_ln_RestructureOption = this.template.querySelector(`[data-field-name="cx_ln_RestructureOption__c"][data-object-name="CaseAnnex__c"]`)?.value;
        this.fetchConfigJson();
        console.log("-->fieldName == 'cx_ln_RestructureOption__c' changed to " + this.cx_ln_RestructureOption);
      }
      ...
      if (fieldName == 'cx_ln_Approved_Loan_Amount__c' || fieldName == 'cx_ln_Approved_Duration_Months__c' /*|| fieldName == 'cx_ln_ApprovedInterestProfitRateReducing__c'*/ ||
        ...
        fieldName == 'cx_Approved_Partial_payment_option__c' || fieldName == 'cx_ln_RestructureOption__c' || fieldName == 'cx_ln_ApprovedNewRate__c' || fieldName == 'EarlyRepaymentPrincipalAmount__c' || fieldName == 'ApprovedLoanTopUpDuration__c') {
  ...
  async saveRecords(records) {
    try {
      //await this.updateRecords(records.Case);//toCheck : ...
...
*/
  ...
  fetchBcrbDetailsButton() {
    ...
    if (this.disableGenerateScheduleButton == false) {
      this.showToast('Error', "you should generate first the schedule using the button : " + this.buttonGenerateScheduleLabel, 'error');
    } else {
      this.loadingSpinner = true;
    ...
    return [
      {
        ...
        "fields": [
          ...
          {
            "fieldAPIName": "cx_ln_TotalCreditCardsInstallments__c",//new field added
            "fieldValue": bcrbData.totalCreditCardInstallments //change this "bcrbData.totalCreditCards"
          },
          {
      ...
      },
      {
        ...
        "fields": [
          ...
          {
            "fieldAPIName": "cx_ln_Credit_Bureau_Risk_Rating__c",
            "fieldValue": bcrbData.creditBureauRiskRating
          },
          {
            "fieldAPIName": "cx_ln_Current_PSI_Transaction_No__c",
    ...
    generateRepaymentSchedule({ caseId: this.recordId, caseAnnexId: this.recordAnnexId })
      .then(result => {
        if (result.status == 'Success') {
          ...
          //toDo : call this multiple times if needed ??
      ...
      .then(result => {
        ...
        if (result.isSuccess == true) {
          if (result.headerData != null) {
            ...
            this.showToast('call Get Schedule List API response is empty .. retry ' + this.getScheduleRetries + '/15', '"data":[]', 'warning');
            if (this.getScheduleRetries <= 14) {
              setTimeout(() => {
                this.getSimulationPaymentListFunc();
              }, 10000);
            } else {
              this.showToast('call Get Schedule List API response is empty', '"Max retries has been reached 15/15', 'error')
              this.loadingSpinner = false;
            }
            // this.showToast('call Get Schedule List API response is empty','"data":[]', 'warning');
            // this.loadingSpinner = false;
          }
        } else {
          if (this.getScheduleRetries <= 14) {
