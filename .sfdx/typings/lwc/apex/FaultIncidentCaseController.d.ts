declare module "@salesforce/apex/FaultIncidentCaseController.getFaultIncidentRecordTypeId" {
  export default function getFaultIncidentRecordTypeId(): Promise<any>;
}
